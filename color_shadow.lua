...
local function showHelp()
  app.alert{
      ...
      text={
          ...
          "- Base: Al hacer clic en un color base se cambia la paleta generada.",
          "- \"Obtener\": Actualiza colores base con FG/BG actual y regenera.",
          "",
          "Acciones del ratón en cualquier muestra:",
          "- Clic Izq: Establece color como FG.",
          "- Clic Der: Establece color como BG.",
          "- Clic Medio: Cambia FG/BG según el último modificado y regenera.",
          "",
          "Controles Avanzados:",
          "- Temperatura (Temp. Osc. y Temp. Clara): Ajusta la tonalidad cálida/fría en sombras oscuras y claras.",
          "- Intensidad: Añade un gradiente de saturación a las sombras.",
          "- Pico: Controla hasta qué punto aumenta la luminosidad en las sombras más claras.",
          "- Oscilación: Ajusta cuánto influyen las temperaturas en las tonalidades resultantes.",
          "- Ranuras: Cambia el número de muestras de color generadas.",
          "",
          "Opciones Cromáticas: Muestra combinaciones armónicas (Compl., Tríada, Tétrada) para inspirar paletas basadas en relaciones de color.",
          "",
          "Selección Automática: Si se activa, al cambiar FG/BG se recalcula automáticamente.",
          "Avanzado: Muestra u oculta los controles avanzados.",
          "",
          "Restablecer: Vuelve los parámetros a sus valores predeterminados."
      }
  }
end
